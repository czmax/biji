...
public Goods buildGoods(Spu spu) throws IOException {
    ...
    List<SpecParam> params =
        this.specificationClient.querySpecParam(null, spu.getCid3(), true, null);
    // 查询sku信息
    ...
    // 获取商品详情中的规格值
    Map<String, Object> genericSpecs = mapper.readValue(detail.getGenericSpec(), new TypeReference<Map<String, Object>>() {
    });
    Map<String, List<String>> specialSpecs = mapper.readValue(detail.getSpecialSpec(), new TypeReference<Map<String, List<String>>>() {
    });
